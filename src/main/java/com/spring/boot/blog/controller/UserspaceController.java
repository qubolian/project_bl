...
public class UserspaceController {
	...
	public String saveProfile(User user, @PathVariable("username") String username,
		...
		/*
		 * // 判断密码是否做了变更 String rawPassword = originalUser.getPassword();
		 * PasswordEncoder encoder = new BCryptPasswordEncoder(); String
		 * encodePasswd = encoder.encode(user.getPassword()); boolean isMatch =
		 * encoder.matches(rawPassword, encodePasswd); if (!isMatch) {
